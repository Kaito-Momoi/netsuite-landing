...
const HeroSection: React.FC<HeroSectionProps> = React.memo(({
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden" aria-labelledby="hero-title">
      <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-white to-sky-50" aria-hidden="true"></div>
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-blue-200 rounded-full filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '2s' }}></div>
      
      <div className="relative z-10 max-w-7xl mx-auto text-center py-20">
        <h1 id="hero-title" className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-8 text-slate-900 leading-tight tracking-tight">
          {title}
        </h1>
