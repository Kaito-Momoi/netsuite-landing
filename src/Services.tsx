  ...
  const services: ServiceCard[] = [
    {
      ...
      title: 'NetSuite導入支援',
      description:
        'お客様のビジネスプロセスを徹底分析し、NetSuiteの導入から稼働まで一貫してサポートします。',
    ...
    },
    {
      ...
      title: 'ビジネスコンサルティング',
      description:
        '業務プロセスの改善から組織変革まで、DXを成功に導く戦略的なアドバイスを提供します。',
    ...
    },
    {
      ...
      title: 'カスタマイズ開発',
      description:
        'SuiteScript、SuiteFlowを活用し、お客様の業務に最適化されたシステムを構築します。',
    ...
    },
    {
      ...
      features: ['EC/モール連携', '決済サービス連携', 'WMS/TMS連携', 'BI/分析ツール連携'],
      link: '/ec-integration',
    },
    {
      id: 'data-migration',
    ...
    },
    {
      ...
      features: ['24時間365日監視', 'ヘルプデスク対応', '定期メンテナンス', 'アップデート対応'],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-sky-50/30 to-white">
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">導入プロセス</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              確実な導入を実現する6つのステップ
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">選ばれる理由</h2>
          </div>
