  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-sky-50/30 to-white">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900">対応業務プロセス</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {operations.map((op, index) => (
              <div
                key={index}
                className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 border border-slate-200 hover:border-sky-400"
              >
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-sky-50/30 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900">連携可能システム</h2>
            ...
            {[
              {
                step: 'STEP 1',
                title: '業務分析',
                description: '現在の倉庫オペレーションと課題の把握',
                icon: <Target className="w-6 h-6" />,
              },
              {
                step: 'STEP 2',
                title: '機器選定',
                description: 'ハンディターミナル等の機器選定',
                icon: <Database className="w-6 h-6" />,
              },
              {
                step: 'STEP 3',
                title: '連携構築',
                description: 'WMSとNetSuiteのシステム連携',
                icon: <Settings className="w-6 h-6" />,
              },
              {
                step: 'STEP 4',
