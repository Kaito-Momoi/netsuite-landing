      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="bg-gray-50 p-6 rounded-lg mb-8">
          <p className="text-gray-700 leading-relaxed">
            ...
            同社は
            <strong className="font-semibold">NetSuite導入支援を専門とするITサービス企業</strong>
            として、2021年2月18日を最終改訂日とする情報セキュリティポリシーと、
            利用条件を公開しています。親会社のエバンテック株式会社が
            <strong className="font-semibold">ISO/IEC 27001:2022認証</strong>
            を取得していることは信頼性の証となります。
          </p>
        </div>
          ...
          <ul className="space-y-2 pl-6">
            <li className="text-gray-700 leading-relaxed">
              ...
              <strong className="font-semibold">
                複製、変更、アップロード、掲載、送信、配布、ライセンシング、販売、出版を含むあらゆる使用
              </strong>
              が、事前の承認なく禁止されています
            </li>
            <li className="text-gray-700 leading-relaxed">
            ...
            <li className="text-gray-700 leading-relaxed">
              •{' '}
              <strong className="font-semibold">
                ウェブサイト上に記載されている企業名や製品名はそれぞれの会社の商標または登録商標
              </strong>
              です
            </li>
          </ul>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            利用条件の免責事項セクションでは、同社が
            <strong className="font-semibold">ウェブサイト情報を予告なく変更する権利</strong>
            を留保し、
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            EvangSol社は
            <strong className="font-semibold">
              リンク先の内容や利用により生じた損害について一切責任を負いません
            </strong>
            。
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <strong className="font-semibold">機密性、完全性、可用性</strong>
            の3つの観点から情報資産を保護する方針を掲げています。
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            <strong className="font-semibold">情報セキュリティマネジメントシステム（ISMS）</strong>
            の確立、実施、監査、見直し、維持を体系的に実施しています。
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            親会社であるエバンテック株式会社は、
            <strong className="font-semibold">JIS Q 27001:2023（ISO/IEC 27001:2022）</strong>
            の認証を取得しています。
          ...
          <p className="text-gray-700 leading-relaxed">
            この認証は2023年10月2日にバージョンFA-07 2.0に更新されており、
            <strong className="font-semibold">継続的な改善プロセス</strong>
            が機能していることを示しています。
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            調査の結果、EvangSol社のウェブサイトには以下の重要な法的文書が
            <strong className="font-semibold">存在しない</strong>ことが判明しました。
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            <strong className="font-semibold">データ主体の権利</strong>
            （アクセス、訂正、削除）に関する具体的な手続きや、
        ...
        <section className="mb-12">
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2 pl-6">
              <li className="text-gray-700 leading-relaxed">
                •{' '}
                <strong className="font-semibold">
                  個人情報に関する問い合わせはinfo@evangsol.co.jp
                </strong>
                に直接連絡する必要があります
              </li>
              <li className="text-gray-700 leading-relaxed">
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2 pl-6">
              <li className="text-gray-700 leading-relaxed">
                • 同社は
                <strong className="font-semibold">サービス中断や内容変更に対する責任を免責</strong>
                しています
              </li>
              <li className="text-gray-700 leading-relaxed">
                • 具体的なSLA約束が提供されていません
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2 pl-6">
              <li className="text-gray-700 leading-relaxed">
                • 契約前に具体的なSLA文書の提供を要求すること
              </li>
              <li className="text-gray-700 leading-relaxed">
                • データ保持と削除手順を明確化すること
              </li>
              <li className="text-gray-700 leading-relaxed">
                • ビジネス関係においては明確なデータ処理契約を締結すること
              </li>
              <li className="text-gray-700 leading-relaxed">
                • サービス条件が予告なく変更される可能性を理解すること
              </li>
              <li className="text-gray-700 leading-relaxed">
                • コンプライアンス要件が契約書に明示的に記載されることを確認すること
              </li>
            </ul>
          </div>
        ...
        <div className="bg-blue-50 p-6 rounded-lg mt-12">
          <p className="text-gray-600 text-sm">
            <strong className="font-semibold">最終更新日：</strong> 2021年2月18日
            <br />
            <strong className="font-semibold">お問い合わせ：</strong> info@evangsol.co.jp
            <br />
