  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        {/* <div
          className="pointer-events-none fixed w-64 h-64 bg-gradient-radial from-indigo-500/20 to-transparent rounded-full blur-3xl"
          style={{
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {CORE_FEATURES.map((feature, index) => (
              <div key={index} className="group relative">
                <div className="absolute inset-0 bg-gradient-to-r from-indigo-600/20 to-blue-600/20 rounded-3xl blur-xl"></div>
                <div className="relative bg-white backdrop-blur-xl rounded-3xl p-8 border-2 border-slate-300/50 h-full">
                  <div className="w-20 h-20 bg-gradient-to-br from-indigo-600/20 to-blue-600/20 rounded-2xl flex items-center justify-center mb-6 border-2 border-indigo-400">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {INDUSTRIES.map((industry, index) => (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-r ${industry.color} rounded-3xl blur-xl ${hoveredIndustry === index ? 'opacity-40' : 'opacity-20'}`}></div>
                <div className="relative bg-white backdrop-blur-xl rounded-3xl p-6 border-2 border-slate-300/50 h-full">
