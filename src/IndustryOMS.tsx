...
const IndustryOMS = () => {
  ...
  const industries = [
    ...
    },
    {
      ...
      name: '卸売業',
      features: ['多段階価格設定', '仕切価格管理', 'リベート計算', '直送手配管理'],
    },
    {
      icon: <ShoppingBag className="w-8 h-8" />,
      name: '小売業',
      features: ['店舗在庫連携', 'セット商品管理', 'ポイント連携', '予約販売管理'],
    },
    {
      icon: <Building2 className="w-8 h-8" />,
      name: '商社',
      features: ['輸入業務管理', '為替管理', 'コミッション計算', '三国間貿易対応'],
    },
  ];
            ...
            {[
              {
                step: 'STEP 1',
                title: '業務分析',
                description: '現行の受注業務フローと課題の把握',
                icon: <Target className="w-6 h-6" />,
              },
              {
                step: 'STEP 2',
                title: 'システム設計',
                description: '業界特化機能の設計とカスタマイズ',
                icon: <Database className="w-6 h-6" />,
              },
              {
                step: 'STEP 3',
                title: '実装・テスト',
                description: 'NetSuiteへの実装と受注処理テスト',
                icon: <Settings className="w-6 h-6" />,
              },
              {
                step: 'STEP 4',
